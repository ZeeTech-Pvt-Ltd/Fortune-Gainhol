...
export default function ThankYou() {
  useMeta({
    title: 'Thank You - Your Fortune Gainhol Registration Is Received',
    description: 'Your Fortune Gainhol registration has been received. Our team will contact you shortly.',
